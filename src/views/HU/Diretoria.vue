<template>
    <div class="section">
        <div class="container">
            ...
            <br>
            <p class="has-text-weight-bold">Diretor de Infraestrutura</p>
            <p>Leandro Becker</p>
            <br>
            <p class="has-text-weight-bold">Diretor Técnico</p>
            <p>Fernando Rogério Beylouni Farias</p>
            <br>
            <p class="has-text-weight-bold">Diretor Clínico</p>
            <p>Paulo de Jesus Hartmann Nader</p>
            <br>
