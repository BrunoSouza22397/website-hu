<template>
    <div class="section">
        <div class="container">
            ...
            <br>
            <p class="has-text-weight-bold is-size-4">Diretor Técnico</p>
            <p class="is-size-5">Fernando Rogério Beylouni Farias</p>
            <br>
            <p class="has-text-weight-bold is-size-4">Diretor Clínico</p>
            <p class="is-size-5">Paulo de Jesus Hartmann Nader</p>
            <br>
            <p class="has-text-weight-bold is-size-4">Diretora Assistencial</p>
            <p class="is-size-5">Janine Sulzbach</p>
        </div>
    </div>
</template>
